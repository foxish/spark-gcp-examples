...
/**
 * A simple Spark Streaming example that gets words from a Cloud PubSub topic, computes the
 * word counts, and writes the result of each batch to a file on GCS.
 */
public class CloudPubSubStreamingWordCount {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        hadoopConf.set(EntriesCredentialConfiguration.BASE_KEY_PREFIX +
