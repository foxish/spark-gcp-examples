 ...
 * publicdata:samples.shakespeare and writes output to a user-specified GCS bucket at
 * path /spark/output/wordcount. GCS is also used as temporary storage for both data
 * exported from the input BigQuery table.
 */
